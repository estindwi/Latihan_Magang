...
<div class="max-w-xl mx-auto bg-white p-6 rounded shadow">
    <h1 class="text-xl font-bold mb-4">Tambah Pasien</h1>
    ...
    <form action="{{ route('pasien.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="nik" class="border p-2 w-full rounded" value="{{ old('nik') }}">
        </div>
        ...
        <div>
            ...
            <input type="date" name="tanggal_lahir" class="border p-2 w-full rounded" value="{{ old('tanggal_lahir') }}">
        </div>

        <div>
            <label class="block mb-1">Alamat</label>
            <textarea name="alamat" class="border p-2 w-full rounded">{{ old('alamat') }}</textarea>
        </div>

        <div>
            <label class="block mb-1">No HP</label>
            <input type="text" name="no_hp" class="border p-2 w-full rounded" value="{{ old('no_hp') }}">
        </div>
